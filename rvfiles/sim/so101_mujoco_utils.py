...
def convert_to_degrees(dictionary) -> dict:
    return {
        'shoulder_pan': dictionary['shoulder_pan']*180.0/3.14159,
        'shoulder_lift': dictionary['shoulder_lift']*180.0/3.14159,
        'elbow_flex': dictionary['elbow_flex']*180.0/3.14159,
        'wrist_flex': dictionary['wrist_flex']*180.0/3.14159,
        'wrist_roll': dictionary['wrist_roll']*180.0/3.14159,
        'gripper': dictionary['gripper']*100.0/3.14159 # convert to 0-100 range
    }

def set_initial_pose(d, position_dict: dict):
...
def move_to_pose(m, d, viewer, desired_position, duration: float):
    """
